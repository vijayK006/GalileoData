          ...
          <div className='row align-items-center'>
            ...
            >
              <div className='section-title mt-5 mt-lg-0'>
                ...
                <h2 className='title'>
                Why Choose Galileo Data <span>Construction Companies</span> Email List?
                  ...
                  <div className='col-md-12 mt-4 mb-4'>
                    <div className='single-about-inner'>
                      ...
                      <div className='details'>
                        ...
                        We don’t include any contact on our list that have opted out of email marketing as a medium.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* Work Process One */}
        ...
        <div className='container'>
          <div className='section-title text-center'>
            <h2 className='title'>
            Know What You Can Do With Our Human Verified <span className="color-default-h">Customer Support & Intelligence</span> 
