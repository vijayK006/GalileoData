          ...
          <div className='row align-items-center'>
            ...
            >
              <div className='section-title mt-5 mt-lg-0'>
                ...
                Most marketers acquire a Manufacturing email list that comprises of outdated email addresses or
                 email addresses of random contacts. Either way, such marketers do not get much help from this 
                 type of list. Ideally, a customized direct mailing address list of targeted manufacturers should
                  be purchased to approach all the industry verticals. To aid the most gainful marketing venture,
                   Galileo Data offers its highly responsive manufacturer mailing database.</p>
